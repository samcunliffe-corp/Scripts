...
print_header "Installing PowerShell Core Prerequisites..."
apt-get install -y wget apt-transport-https software-properties-common
 
print_header "Downloading the Microsoft repo keys..."
wget -q https://packages.microsoft.com/config/ubuntu/$VERSION_ID/packages-microsoft-prod.deb
 
print_header "Registering the Microsoft repo keys..."
dpkg -i packages-microsoft-prod.deb
 
print_header "Deleting the Microsoft repo keys file..."
rm packages-microsoft-prod.deb
 
print_header "Updating the list of packages after adding packages.microsoft.com..."
apt-get update
 
print_header "Installing PowerShell Core..."
apt-get install -y powershell
 
print_header "Finished installing PowerShell Core"